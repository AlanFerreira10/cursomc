...
import com.alanferreira.cursomc.domain.Cidade;
import com.alanferreira.cursomc.domain.Cliente;
import com.alanferreira.cursomc.domain.Endereco;
...
import com.alanferreira.cursomc.repositories.ProdutoRepository;
...
public class DBService {
	...
	public void instantiateDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "ferreira.alan10@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

		Cliente cli2 = new Cliente(null, "Ana Costa", "alan.ferreira10@gmail.com", "72398616002", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("98984422", "56229855"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 203", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2106", null, "Centro", "34577012", cli2, c2);
